...
<div class="">
    ...
    <input class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded"   type="text"  placeholder="Nome" aria-label="Name" name="name" value="{{ $lesson->name ?? old('name')}}">
</div>
<div class="">
    <label class="block text-sm text-gray-600" for="name">Vídeo *</label>
    <input class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" type="text"  placeholder="Video" aria-label="Video" name="video" value="{{ $lesson->video ?? old('video')}}">
</div>
<div class="mt-2">
