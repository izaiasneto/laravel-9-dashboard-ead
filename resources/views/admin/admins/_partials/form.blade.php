...
<div class="">
    ...
    <input class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="name"  type="text"  placeholder="Nome" aria-label="Name" name="name" value="{{ $admin->name ?? old('name')}}">
</div>
<div class="mt-2">
...
<div class="mt-2">
    ...
    <input class="w-full px-5  py-2 text-gray-700 bg-gray-200 rounded" id="password"  type="password"  placeholder="Senha" aria-label="Senha" name="password">
</div>
<div class="mt-6">
